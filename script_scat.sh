...
mpirun -np $NPROCS /c14scratch/apps/siesta/v5.4/bin/siesta input.fdf | tee output.txt

mpirun -np $NPROCS /c14scratch/apps/siesta/v5.4/bin/tbtrans input.fdf | tee tb_output.txt
